# Spring PetClinic Sample Application [![Java CI with Maven](https://github.com/earthcha/spring-petclinic/actions/workflows/maven.yml/badge.svg)](https://github.com/earthcha/spring-petclinic/actions/workflows/maven.yml)
